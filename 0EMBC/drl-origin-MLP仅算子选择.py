...
def make_state_vec(
    ...
    return np.array([
        ...
        is_run0_best, run0_gap, stagnation, budget,
...
'''
# 训练并保存 ckpt
CUDA_VISIBLE_DEVICES=3 python /home/preprocess/_funsearch/baseline/0EMBC/drl-origin-MLP仅算子选择.py \
  --mode train \
...
CUDA_VISIBLE_DEVICES=3 nohup python /home/preprocess/_funsearch/baseline/0EMBC/drl-origin-MLP仅算子选择.py \
    --mode train \
    --coe_path "/home/preprocess/_funsearch/baseline/coe-位置级-子种群对齐.py" \
    --patient_file "/home/preprocess/_funsearch/baseline/data/实验数据6.1 - 副本.xlsx" \
    --duration_file "/home/preprocess/_funsearch/baseline/data/程序使用实际平均耗时3 - 副本.xlsx" \
    ...
    --K 4 --B 50 --generations 5000 --elite_size 5 \
    --train_episodes 50 \
    --ckpt_path drl_coe_ckpt.pt --save_every 1 > drl.log 2>&1 &
